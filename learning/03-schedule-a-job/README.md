...
![DAB Architecture Setup](../../docs/learning/03-schedule-a-job/01-architecture-diagram.png)
...
![Validation Deploy Success](../../docs/learning/03-schedule-a-job/02-validation-deploy-success.png)
...
![Workflow UI View](../../docs/learning/03-schedule-a-job/03-scheduled-job-ui.png)