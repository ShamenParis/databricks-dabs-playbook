...
![DAB Architecture Setup](../../docs/learning/05-table-update-trigger/01-architecture-diagram.png)
...
![Validation Deployment Success](../../docs/learning/05-table-update-trigger/02-validation-deploy-success.png)
...
![Workspace UI](../../docs/learning/05-table-update-trigger/03-workspace-ui.png)
