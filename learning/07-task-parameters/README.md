...
![DAB Architecture Setup](../../docs/learning/07-task-parameters/01-architecture-diagram.png)
...
![Validation and Deployment Success](../../docs/learning/07-task-parameters/02-validation-deploy-success.png)
...
![Run Workflow Success](../../docs/learning/07-task-parameters/03-workflow-ui.png)

**Step 3: Verify the output**

Task B and Task C execute in parallel. Each receives the values broadcast by Task A.

<video src="../../docs/learning/07-task-parameters/04-task-parameters.mp4" width="100%" controls></video>
