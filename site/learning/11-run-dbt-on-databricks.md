---
layout: default
title: "11. Run dbt on Databricks"
parent: Learning Modules
nav_order: 11
permalink: /learning/11-run-dbt-on-databricks
---

# 11: Run dbt on Databricks

<a href="https://github.com/ShamenParis/databricks-dabs-playbook/tree/main/learning/11-run-dbt-on-databricks" class="btn-source" target="_blank">📂 View Source Code</a>
...
![DAB Architecture Setup]({{ site.baseurl }}/images/learning/11-run-dbt-on-databricks/01-architecture-diagram.png)
