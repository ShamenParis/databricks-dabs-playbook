...
nav_order: 10
permalink: /learning/10-run-sql-alerts
---

# 10: SQL Alerts

<a href="https://github.com/ShamenParis/databricks-dabs-playbook/tree/main/learning/10-run-sql-alerts" class="btn-source" target="_blank">📂 View Source Code</a>
...
![DAB Architecture Setup]({{ site.baseurl }}/images/learning/10-run-sql-alerts/01-architecture-diagram.png)
...
![Success Job Run]({{ site.baseurl }}/images/learning/10-run-sql-alerts/02-success-ui.png)
...
![Triggered Alert]({{ site.baseurl }}/images/learning/10-run-sql-alerts/03-triggered_alert.png)
